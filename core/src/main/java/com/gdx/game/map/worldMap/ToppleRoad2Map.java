...
public class ToppleRoad2Map extends GameMap {
    private static final String MAP_PATH = "maps/topple_road_2.tmx";
    
    public ToppleRoad2Map() {
        super(MAP_PATH, MapFactory.MapType.TOPPLE_ROAD_2);
    }
