...
public class ToppleRoad1Map extends GameMap {
    private static final String MAP_PATH = "maps/topple_road_1.tmx";
    
    public ToppleRoad1Map() {
        super(MAP_PATH, MapFactory.MapType.TOPPLE_ROAD_1);
    }
